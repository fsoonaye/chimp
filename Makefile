...
HEADERS := include/chess.hpp src/engine.h src/types.h src/uci.h src/evaluate.h src/bench.h src/time.h src/perft.h src/hash.h src/arrays.h src/movepicker.h
